# Official Notice: Organization Archival (Effective March 11, 2026)

To all contributors, users, and observers of this repository:

This organization will be formally **archived on [March 11, 2026 — one month from posting]**.

The decision to archive is intended to prevent confusion with similarly named efforts and to avoid ambiguity resulting from the absence of ongoing updates. Current IOF research and development is conducted in the [IOF Foundry Organization](https://github.com/iofoundry). Current NCOR developments can be tracked in the [NCOR Network Organization](https://github.com/NCOR-Organization). 
